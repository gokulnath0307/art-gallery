...
export const MemberLoginPage = () => {
  ...
  return (
    <div className="relative">
      {/* Background Image */}
      <img
        src="https://images.pexels.com/photos/3183786/pexels-photo-3183786.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
        ...
        <div className="relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between xl:flex-row">
            ...
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              <h2 className="max-w-lg mb-6 text-3xl font-bold tracking-tight text-white sm:text-4xl">Discover & Showcase Stunning Artworks</h2>
              <p className="max-w-xl mb-4 text-base text-gray-300 md:text-lg">
                Join our creative community and explore breathtaking paintings from talented artists worldwide.
              </p>
              <a
                href="/"
            ...
            <div className="w-full max-w-xl xl:px-8 xl:w-5/12">
              <div className="bg-white rounded-lg shadow-xl p-7 sm:p-10">
                <h3 className="mb-4 text-xl font-semibold text-gray-800 sm:text-center sm:mb-6 sm:text-2xl">Art Member Login</h3>
                <>
                  <div className="mb-4">
                  ...
                  <div className="mt-4">
                    <button
                      ...
                      type="submit"
                      className="w-full h-12 px-6 cursor-pointer font-medium text-white transition bg-purple-500 rounded shadow-md hover:bg-purple-600 focus:ring-2 focus:ring-purple-400 focus:outline-none"
                    >
                      Login
                    </button>
                  </div>
                  <p className="mt-2 text-xs text-gray-600 sm:text-sm">Showcase your art & connect with other artists. It's free to join!</p>
                  <p className="mt-4 text-center text-gray-600">
                    New here?{" "}
                    <a href="/member-register" className="text-purple-500 hover:underline">
